		...
		<div id="boardList">
			<table>
				...
				<tbody>
						...
						<td class="title"><a
							href="./view.php?bno=<?php echo $row['b_no']?>"><?php echo $row['b_title']?></a>
						</td>
			...
			<div class="btnSet">
				<a href="./write.php" class="btnWrite btn"><button>글쓰기</button></a>
			</div>
			<div class="paging">
				<?php echo $paging?>
			</div>
			<div class="searchBox">
				<form action="./index.php" method="get">
					<select name="searchColumn"
						style="width: 200px; height: 100px; marign: 0px 0px 10px 0px;">
						<option
							<?php echo $searchColumn=='b_title'?'selected="selected"':null?>
							value="b_title">제목</option>
						<option
							<?php echo $searchColumn=='b_content'?'selected="selected"':null?>
							value="b_content">내용</option>
						<option
							<?php echo $searchColumn=='b_id'?'selected="selected"':null?>
							value="b_id">작성자</option>
					</select> <input type="text" style="width: 500px; height: 100px;"
						name="searchText"
						value="<?php echo isset($searchText)?$searchText:null?>">
					<button type="submit" style="width: 200px; height: 100px;">검색</button>
				</form>
			</div>
		</div>
	</article>
